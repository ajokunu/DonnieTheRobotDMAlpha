Add a session start and session End for campaigns that allows the summary of the episode so you can use episode start and it starts where you left off. Should cache last episode.
